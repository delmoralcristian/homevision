...
public class HouseManagementController {
    ...
    public ResponseEntity<HousesAPIRootResponseDTO> getHouses(@ApiParam(value = "The page number you want to retrieve (default is 1)")
                                                              @RequestParam(value = "page", required = false, defaultValue = "1") Integer page,
                                                              @ApiParam(value = "The number of houses per page (default is 10)")
